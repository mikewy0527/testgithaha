/*
 * Port from Linux kernel linked list, modified for userspace
 * 1. Surround 'typeof' and 'offsetof' with two underscores both sides for work
 *    when included in ISO C programs
 * 2. Surround variable 'new' with '_e' to resolve conflicts with C++ keyword
 */

#ifndef _LINUX_US_LIST_H
#define _LINUX_US_LIST_H
...
/*
 * Port from include/linux/stddef.h
 */
#undef __offsetof__
#ifdef __compiler_offsetof
#define __offsetof__(TYPE, MEMBER)	__compiler_offsetof(TYPE, MEMBER)
#else
 ...
 * @new_e : the new element to insert
 *
